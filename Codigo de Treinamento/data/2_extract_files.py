        ...
        for vid_class in class_folders:
            ...
            for video_path in class_files:
                ...
                if not check_already_extracted(video_parts):
                    # Now extract it.
                    src = os.path.join("C:\\Users\\Gabriel\\Documents\\PycharmProjects\\TesteLSTM\\five-video-classification-methods-master\\data", train_or_test, classname, filename)
                    dest = os.path.join("C:\\Users\\Gabriel\\Documents\\PycharmProjects\\TesteLSTM\\five-video-classification-methods-master\\data", train_or_test, classname, filename_no_ext + '-%04d.jpg')
                    #print(os.path.exists(src), dest)
                    #print("C:\\ffmpeg\\bin", "-i", src, dest)
